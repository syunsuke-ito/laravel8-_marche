                        ...
                        <div class="container px-5 mx-auto">
                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3">
                                        <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id ])}}'" class="text-white bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-500 rounded">編集</button>
                                    </td>
