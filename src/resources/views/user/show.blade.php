        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="border-t border-gray-400 m-8"></div>
                    ...
                    <div class="mb-4 text-center">
                      @if($product->shop->filename !== null)
                        <img class="object-cover mx-auto w-40 h-40 rounded-full" src="{{ asset('storage/shops/' . $product->shop->filename ) }}">
                      @else
                        <img src="">
                      @endif
                    </div>
                    <div class="mb-4 text-center">
                      <button href='javascript:;' data-micromodal-trigger="modal-1" type="button" class="text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-500 rounded">ショップの詳細を見る</button>
                    </div>
                </div>
            </div>
        </div>
